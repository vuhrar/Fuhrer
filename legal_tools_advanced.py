...
class LegalDeadlinesTracker:
    ...
    DEADLINES = {
        ...
        "تأخير راتب": {
            "description": "مهلة امتناع الموظف عن العمل بسبب تأخير صرف الأجور",
            "days": 7, "article": "90",
...
class LegalSlipDetector:
    ...
    PATTERNS = [
        ...
        (r"(لا نعترف|لم نقر|لا نقر)\s*(بـ|ب)?\s*(حقوق|مستحقات|علاوة)", "رفض الإقرار بالحقوق النظامية", "danger", "84",
